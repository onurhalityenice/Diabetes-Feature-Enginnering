...
# Objective: It is desired to develop a machine learning model that can predict whether people have diabetes
# when their characteristics are specified.

# It is expected to perform the necessary data analysis and feature engineering steps before developing the model.
...
df = pd.read_csv("Miuul/WEEK_6/datasets/diabetes.csv")
df.head()
...
# It is known that variable values other than Pregnancies and Outcome cannot be 0.
# Therefore, NaN can be assigned to values that are 0 in these values.
